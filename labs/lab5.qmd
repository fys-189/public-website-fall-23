...
In this lab, we will examine a series of common errors in reasoning that emerge when presenting data-based evidence or when countering data-based evidence. 
